    ...
    <nav class="navbar navbar-expand-sm navbar-default">
      <div class="navbar-header">
        <a class="navbar-brand" href="./"
          ><img src="/resources/images/" alt="Logo"
        /></a>
      </div>
    </nav>
    <div class="content">
          ...
          <div class="card text-white bg-flat-color-4">
            <div class="card-body pb-20">
              ...
              <div class="watherIcons">
                <i
                  class="fa-solid fa-temperature-high fa-shake fa-2xl"
                  id="watherIcon"
                ></i>
              </div>
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="card text-white bg-flat-color-3">
            <div class="card-body pb-20">
              ...
              <h4 class="mb-0"><span class="count">10468</span>%</h4>
              <div class="watherIcons">
                <i
                  class="fa-regular fa-sun fa-bounce fa-2xl"
                  id="watherIcon"
                ></i>
              </div>
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="card text-white bg-flat-color-1">
            <div class="card-body pb-20">
              ...
              <h4 class="mb-0"><span class="count">30</span>m/s</h4>
              <div class="watherIcons">
                <i
                  class="fa-solid fa-cloud-showers-heavy fa-beat fa-2xl"
                  id="watherIcon"
                ></i>
              </div>
              <div class="chart-wrapper px-0" style="height: 70px">
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="card text-white bg-flat-color-2">
            <div class="card-body pb-20">
              ...
              <h4 class="mb-0"><span class="count">18</span>mm</h4>
              <div class="watherIcons">
      ...
      <div class="weatherstatus">
        ...
        <div class="donut">
          <div class="donutChart">
            <span class="donut" data-peity='{ "fill": ["#99D683", "#fafafa"]}'
              >2,6</span
            >
            ...
            <div class="row">
              ...
              <div class="col-sm-8 hidden-sm-down">
                ...
                >
                  ...
                  >
                    <label class="btn btn-outline-secondary">
                      <input type="radio" name="yesterday" id="yesterday" />
                      어제
                    </label>
                    <label class="btn btn-outline-secondary active">
